...
<body>
    <div class="btns">
        <button type="button" id="edit_submit_btn" data-i="${staff.id}">提交</button>
    </div>
                ...
                <table>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" class="required"  value="${staff.name}" data-c="姓名" id= "username" name="name"  onblur="checkName()">
                            </td>
                            <td class="item_name"><span class="red">*</span> 手机号码</td>
                            <td>
                                <input type="text" class="required formated" value="${staff.phoneNum}" data-c="手机号码" name="phoneNum">
                            </td>
                            <td class="item_name"><span class="red">*</span> 身份证号码</td>
                            <td>
                                <input type="text" class="required formated" value="${staff.idCard}" id="id_card" data-c="身份证号码" name="idCard">
                            </td>
                        </tr>
                        <tr>
                            <td class="item_name"><span class="red">*</span> 入职时间</td>
                            <td>
                                <input type="text" class="input_m ms_datepicker required" value="${staff.entryDate}" data-c="入职时间" name="entryDate" placeholder="例2013-01-02">
                            </td>
                        ...
                        <tr>
                           ...
                           <td class="item_name"><span class="red">*</span>分部  </td>
                            <td>
                                <select id="fenbu" class="select_m"  data-v="${staff.storeId}" name="storeId">
                        ...
                        <tr>
                            ...
                            <td>
                                <select id="position" class="select_m required" name="position" data-v="${staff.position}">
                ...
                <table>
                    <tbody>
                        <tr>
                            ...
                            <td><select name="contractType" id="contractType" data-v="${staff.contractType}">
                            ...
                            <td>
                                ...
                                <input type="hidden" value="${staff.contractNum }" name="contractNum"  id="contractNum" data-v="${staff.contractNum }" data-v2="${staff.contractNum }"/>
                        ...
                        <tr>
                            ...
                            <td><input type="text" class="required formated" value="${staff.bankCardNum}" name="bankCardNum" id="bank_card_num"></td>
                            <td class="item_name"><span class="red">*</span> 开户银行</td>
                            <td><input type="text" class="required" value="${staff.bankName}" name="bankName" id="bank_name"></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" class="input_s" name="nation" value="${staff.nation}">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="generationCertification" value="${staff.generationCertification}"></td>
                        ...
                        <tr>
                            ...
                            <td><input type="checkbox" name="haveCar" value="是" id="haveCar" data-v ="${staff.haveCar}"></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                ...
                                （备注 <input type="text" name="physicalRemark" value="${staff.physicalRemark}">）
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td></td>
                            <td colspan="3">
                                <input class="long" type="text" data-c="户籍地址" value="${staff.domicilePlaceDetail}" name="domicilePlaceDetail" placeholder="请输入详细地址">
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input type="text" class="ms_datepicker" name="payTime1" value="${staff.list[0].payTime }"></td>
                            <td class="item_name">打款金额</td>
                            <td><input type="text"  name="payMoney1" class="formated" data-c="金额" value="${staff.list[0].payMoney }"></td>
                            <td class="item_name">打款账户</td>
                            <td>
                                <c:if test="${staff.list[0].account==null}"><input type="text" name="account1" value="宋总账户" ></c:if>
                                <c:if test="${staff.list[0].account!=null}"><input type="text" name="account1" value="${staff.list[0].account }" ></c:if>
                            </td>
                        </tr>
                    
                        <tr>
                            <td class="item_name">打款时间</td>
                            <td><input type="text" class="ms_datepicker" name="payTime2" value="${staff.list[1].payTime }"></td>
                            <td class="item_name">打款金额</td>
                            <td><input type="text"  name="payMoney2" class="formated" data-c="金额" value="${staff.list[1].payMoney }"></td>
                            <td class="item_name">打款账户</td>
                            <td>
                                <c:if test="${staff.list[1].account==null}"><input type="text" name="account2" value="宋总账户" ></c:if>
                                <c:if test="${staff.list[1].account!=null}"><input type="text" name="account2" value="${staff.list[1].account }" ></c:if>
                            </td>
                        </tr>
                        
                        <tr>
                            <td class="item_name">打款时间</td>
                            <td><input type="text" class="ms_datepicker" name="payTime3" value="${staff.list[2].payTime }"></td>
                            <td class="item_name">打款金额</td>
                            <td><input type="text"  name="payMoney3" class="formated" data-c="金额" value="${staff.list[2].payMoney }"></td>
                            <td class="item_name">打款账户</td>
                            <td>
                                <c:if test="${staff.list[2].account==null}"><input type="text" name="account3" value="宋总账户" ></c:if>
                                <c:if test="${staff.list[2].account!=null}"><input type="text" name="account3" value="${staff.list[2].account }" ></c:if>
                            </td>
                        </tr>
                ...
                <table>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="industryInvolved1" value="${workExp[0].industryInvolved}"></td>
                        </tr>
                        <tr>
                        ...
                        <tr class="last_the_same">
                            <td class="item_name">起止年月</td>
                            <td colspan="3"><input type="text" class="input_m ms_datepicker" name="workBeginDate4" value="${workExp[3].workBeginDate}"> — <input type="text" class="input_m ms_datepicker" name="workEndDate4" value="${workExp[3].workEndDate}"></td>
                        </tr>
                        <tr class="last_the_same">
                            <td class="item_name">工作单位</td>
                            <td><input type="text" name="workUnit4" value="${workExp[3].workUnit}"></td>
                            <td class="item_name" value="${workExp[3].workPosition}">职务</td>
                            <td>
                                <input type="text" name="workPosition4">
                ...
                <table>
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <input type="text" name="referrerIdCardName" class="query_id_card" value="${staff.referrerIdCardName}"  placeholder="输入身份证号查询">
                                <input type="hidden" name="referrerIdCard"  value="">
                            </td>
                            <td class="item_name">担保人</td>
                            <td>
                                <input type="text" class="query_id_card"  value="${bondsman1}" placeholder="输入身份证号或姓名">
                                <input type="hidden" name="bondsman1"  value="${bondsman1}">
                            </td>
                            <td class="item_name">有无亲属在本公司</td>
                            <td>
                                <input type="text" class="query_id_card" placeholder="若有，请输入身份证号" value="${rlist[0]}">
                        ...
                        <tr>
                            ...
                            <td class="item_name">担保人</td>
                            <td>
                                <input type="text" class="query_id_card" value="${bondsman2}" placeholder="输入身份证号或姓名">
                                <input type="hidden" name="bondsman2"  value="${bondsman2}">
                            </td>
                            <td class="item_name">有无亲属在本公司</td>
                            <td>
                                <input type="text" class="query_id_card" placeholder="若有，请输入身份证号" value="${rlist[1]}">
                        ...
                        <tr class="add_relatives hide">
                            ...
                            <td class="item_name">有无亲属在本公司</td>
                            <td>
                                <input type="text" class="query_id_card" placeholder="若有，请输入身份证号" value="${rlist[2]}">
                        ...
                        <tr class="add_relatives hide">
                            ...
                            <td class="item_name">有无亲属在本公司</td>
                            <td>
                                <input type="text" class="query_id_card" placeholder="若有，请输入身份证号" value="${rlist[3]}">
                        ...
                        <tr class="add_relatives hide">
                            ...
                            <td class="item_name">有无亲属在本公司</td>
                            <td>
                                <input type="text" class="query_id_card" placeholder="若有，请输入身份证号" value="${rlist[4]}">
