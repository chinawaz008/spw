...
//String abc=request.getScheme() + "://" + request.getServerName() + ":" + request.getServerPort() + "/" + request.getContextPath();
...
String savePath = kaddress;
System.out.println(savePath+"===============");

//文件保存目录URL
//String saveUrl  = request.getContextPath() + "/files/";
String saveUrl =  request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort() + kshow;
...
while (itr.hasNext()) {
	...
	if (!item.isFormField()) {
		...
		if(item.getSize() > maxSize){
			out.println(getError("上传文件大小限制500M以内。"));
			return;
		}
		//检查扩展名
