    ...
    var MsImportExcel = function(){
        ...
        init.prototype = {
            newBox: function() {
                ...
                htmlArr[3] = ctx + this.step1 + "?currentTime="+ currentTime;
            ...
            checkFails: function(){
                ...
                var body = '<table><tbody><tr><td rowspan="2"><i class="iconfont icon-cuowu fails"></i></td><td>文件名：' + $datas.data("name") + 
                            '</td></tr><tr><td>文件总共：'+ $datas.data("total") + '条信息</td><td>有<span class="fails">'+ $datas.data("failnum") +'</span>个错误</td></tr></tbody></table><div class="error_board">'+ $datas.data("detail") +'</div>';
...
//					location.href =  ctx +"/zhonganOrder/personal_settle_list";
//                }
//                location.reload(false);
            }
        };
    ...
    $(".ms_import_excel_sub").click(function(){
