...
public class ImageUtil {
	...
	public static void main(String[] args) {
	        String srcImgPath = "d:/23333.jpg";
	        String iconPath = "d:/logo.jpg";
	        String targerPath = "d:/23333.jpg";
	        // 给图片添加水印
	        ImageUtil.waterMarkImageByIcon(iconPath, srcImgPath, targerPath, 0, 0,0, 0.3f);
	        // 给图片添加水印,水印旋转-45
	...
	public static void waterMarkImageByIcon(String iconPath, String srcImgPath,
		...
		try {
			...
			Image ico = ImageIO.read(new File(iconPath));
			width = srcImg.getWidth(null)-ico.getWidth(null)-10;
			height = srcImg.getHeight(null)-ico.getHeight(null)-10;
