 ...
 * */
public class ThreeDes extends AbstractController{
	...
	public  byte[] hex(String key){
		//String key = getProp().getProperty("key");//关键字
	...
	public static String encode(String str,String key){
		byte[] enk = new ThreeDes().hex(key); 
		Security.addProvider(new com.sun.crypto.provider.SunJCE());
		byte[] encoded = encryptMode(enk,str.getBytes());
	...
	public static String decode(String str,String key){
		byte[] enk = new ThreeDes().hex(key); 
		Security.addProvider(new com.sun.crypto.provider.SunJCE());
		byte[] reqPassword = Base64.decode(str);
	...
	public static void main(String[] args) {
		String s= "611105032688、611105032888";
		String arr[] = s.split("、");
		for (int i = 0; i < arr.length; i++) {
			String r = arr[i].substring(0,10);
			System.out.print(arr[i]+"--->");
			System.out.println(ThreeDes.encode(r, "waz880107LW@"));
		}
	  }
//		解密
	//  public static void main(String[] args) {
//			String s= "h68NjvpkbV5s5oTFYMpg0g==";
//			System.out.println(ThreeDes.decode(s, "waz880107LW@"));
//		  }
